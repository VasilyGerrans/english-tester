...
export default function TermsOfServicePage() {
  ...
  const markdownPath = path.join(process.cwd(), 'content', 'tos.md')
...
export const metadata = {
  title: `Terms of Service - ${process.env.NEXT_PUBLIC_SITE_NAME || "English Tester"}`,
  description: "Terms of Service for our English grammar learning platform.",
}
